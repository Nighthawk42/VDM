...
An isolated copy is running from `/home/nighthawk/apps/vdm-dev` as a user service, `vdm-dev.service`, on `127.0.0.1:18610`. Its four databases live only in `/home/nighthawk/apps/vdm-dev/data`. To view it before any public route change, forward the port with `ssh -L 18610:127.0.0.1:18610 z1-hestia` and open <http://127.0.0.1:18610/> locally.
